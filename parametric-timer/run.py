...
tb.add_config(name="100MHz", generics=dict(clk_freq_hz_g=100e6, delay_g=100000))

# Test Case 2: 50Mz clock with 200ns delay
tb.add_config(name="50MHz", generics=dict(clk_freq_hz_g=50e6, delay_g=200000))

# Test Case 3: 1MHz clock with 10us delay
tb.add_config(name="1MHz", generics=dict(clk_freq_hz_g=1e6, delay_g=10000000))
